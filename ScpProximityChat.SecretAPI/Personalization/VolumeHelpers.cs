...
public static class VolumeHelpers
{
    ...
    /// <returns>The master volume of SCP Proximity Chat.</returns>
    public static float Master(Player receiver)
        => CustomSetting.TryGetPlayerSetting(receiver, out MasterVolume? global)
            ? global.Volume * ProximityChatPlugin.Cfg.AudioSettings.Volume
    ...
    /// <returns>The personalized volume of SCP Proximity Chat for the given receiver and source User ID.</returns>
